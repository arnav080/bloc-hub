    ...
    <div className="min-h-screen bg-[#171616] flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-zinc-900/40 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl relative overflow-hidden">
        ...
        <p className="text-sm font-mono text-zinc-400 mb-8 leading-relaxed">
          Sign in to submit optimized recipes, track your pulls, and manage namespaces.
        </p>
        ...
        {isSupabaseConfigured ? (
          <div className="space-y-3">
            <button
              ...
              className="w-full bg-blue-600 hover:bg-blue-500 text-white font-mono font-bold uppercase tracking-widest text-xs py-3.5 rounded-xl transition-all disabled:opacity-50 flex items-center justify-center gap-2"
            >
            ...
            <button
              ...
              disabled={isLoggingIn}
              className="w-full bg-zinc-800 hover:bg-zinc-700 text-white border border-white/10 font-mono font-bold uppercase tracking-widest text-xs py-3.5 rounded-xl transition-all disabled:opacity-50 flex items-center justify-center gap-2"
            >
              <svg viewBox="0 0 24 24" className="w-4 h-4 fill-white" xmlns="http://www.w3.org/2000/svg">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            >
              {isLoggingIn ? "Authenticating..." : "Connect Session"}
            </button>
          </form>
        )}
